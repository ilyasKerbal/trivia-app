...
class GameWonFragment : Fragment() {
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        Toast.makeText(context, getString(R.string.share_success_text, args.numCorrect, args.numQuestions), Toast.LENGTH_LONG).show()
        return binding.root
    }
    ...
    private fun createShareIntent() : Intent = Intent().apply {
        ...
        // Or USe ShareCompat.IntentBuilder
    }

    private fun shareSuccess(){
        val shareIntent = Intent.createChooser(createShareIntent(), null)
